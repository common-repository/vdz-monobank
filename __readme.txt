...
Donate link:  http://online-services.org.ua#Donate-vdz-monobank
Tags: VDZ Monobank, monobank, bank, exchange rates
...
Курс валют от Монобанка
Для отображения используйте шорткод
[vdz_monobank_shortcode currencies="USD,EUR"]

== Description ==
VDZ Monobank - yours simple exchange rates from monobank
